package com.mautini.assistant.demo;// Wav file IO class
// A.Greensted
...
public class WavFile
{
	...
	// Cannot instantiate com.mautini.assistant.demo.WavFile directly, must either use newWavFile() or openWavFile()
	private WavFile()
	{
	...
	{
		if (ioState != IOState.READING) throw new IOException("Cannot read from com.mautini.assistant.demo.WavFile instance");
	...
	{
		if (ioState != IOState.WRITING) throw new IOException("Cannot write to com.mautini.assistant.demo.WavFile instance");
