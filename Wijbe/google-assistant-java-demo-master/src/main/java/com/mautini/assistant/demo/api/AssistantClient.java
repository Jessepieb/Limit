...
public class AssistantClient implements StreamObserver<AssistResponse> {
    ...
    /**
     * Update the credentials used to request1 the api
     *
     ...
     * @param request the request1 for the assistant (text or voice)
    ...
    /**
     * Create the config message, this message must be send before the audio for each request1
     *
     * @return the request1 to send
     */
