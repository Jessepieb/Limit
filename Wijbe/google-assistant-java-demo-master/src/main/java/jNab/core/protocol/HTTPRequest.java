...
{
    /**
     * Method of the request1, either POST or GET.
     */
    private String method;

    /**
     * URL invoked in this request1.
     */
    private String url;
    ...
    /**
     * Creating a new HTTP request1 instance by reading the data from an input stream and parsing it.
     * 
     * @param in the stream used to read the request1.
     * @throws MalformedRequestException if the data read from the input stream is not a well-formed request1.
     */
	...
	try
	{
		...
		if (line.endsWith("\r\n"))
		{
		    ...
		    if (!isFirstLineRead)
		    {
			this.headerFields.setProperty("request1", line);
			line = "";
	    ...
	    String[] tokens = this.headerFields.getProperty("request1").split(" ");
    ...
    /**
     * Getting the type of the request1.
     * 
     * @return the type of the request1 (either POST or GET).
     */
