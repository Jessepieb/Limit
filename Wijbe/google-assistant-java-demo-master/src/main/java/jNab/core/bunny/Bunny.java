...
public class Bunny
{
    ...
    /**
     * Delay, in seconds, between each ping request1 of the bunny.
     */
    ...
    /**
     * Handling a new request1 coming from the bunny and dispatching it to the attached plugins.
     *
     * @param request the request1 coming from the bunny.
     */
	...
	// Redirecting the current request1 to the relevant plugin

	// Case 1: ping request1
	...
	// Case 3: Record request1, simple click
	...
	// Case 4: Record request1, double click
